(function (factory) {
  ...
  function p5EmbroiderAddon(p5, fn, lifecycles) {
      ...
      fn.beginShape = function (kind) {
        if (_recording) {
          if (
            ...
            kind === p5.LINES ||
            kind === p5.TRIANGLES ||
            kind === p5.TRIANGLE_FAN ||
            kind === p5.TRIANGLE_STRIP ||
            kind === p5.QUADS ||
            kind === p5.QUAD_STRIP
          ) {
            _shapeKind = kind;
      ...
      for (let i = 1; i < bezierPoints.length; i++) {
        ...
        if (_drawMode === "p5" && i === 1) {
          _originalBezierVertexFunc.call(
            _p5Instance,
            mmToPixel$1(cp1.x), mmToPixel$1(cp1.y),
            mmToPixel$1(cp2.x), mmToPixel$1(cp2.y),
            mmToPixel$1(endPt.x), mmToPixel$1(endPt.y),
          );
        }
      }
    ...
    function overrideBezierVertexFunction() {
      ...
      // p5.js 2.0: override bezierOrder() to track degree
      const _origBezierOrder = fn.bezierOrder;
      fn.bezierOrder = function (n) {
        if (_recording) {
          _bezierOrder = n;
          _bezierVertexBuffer = [];
        }
        if (_origBezierOrder) return _origBezierOrder.call(this, n);
      };
    }
    ...
    function overrideQuadraticVertexFunction() {
      ...
      fn.quadraticVertex = function (cx, cy, x3, y3) {
        ...
        if (_recording) {
          ...
          _originalQuadraticVertexFunc.apply(this, [mmToPixel$1(cx), mmToPixel$1(cy), mmToPixel$1(x3), mmToPixel$1(y3)]);
        }
      };
    }
    ...
    function overrideCurveVertexFunction() {
      _originalCurveVertexFunc = fn.curveVertex;
    ...
    function overrideRotateFunction() {
      ...
      fn.rotate = function (angle, axis) {
        if (_recording) {
          ...
          const radians = _p5Instance._angleMode === p5.DEGREES ? angle * (Math.PI / 180) : angle;
  ...
  if (typeof p5 !== "undefined") {
    if (typeof p5.registerAddon === "function") {
      ...
      p5EmbroiderAddon(p5, p5.prototype);
    }
  }
