(function (factory) {
   ...
   */
  async function exportOutline(threadIndex, offsetDistance, filename, outlineType = "convex", embroideryState) {
    const { 
      _recording, 
      _stitchData, 
      _DEBUG 
   ...
   * @returns {void}
   */
  function embroideryOutline(offsetDistance, threadIndex, outlineType = "convex", embroideryState) {
    const { 
      _recording, 
      _stitchData, 
      _strokeThreadIndex, 
