  ...
  (function (global) {
    ...
    function overrideQuadraticVertexFunction() {
      ...
      window.quadraticVertex = function (cx, cy, x3, y3) {
        if (_recording) {
          ...
          const quadraticPoints = generateQuadraticPoints(
            x1,
            y1,
            controlPoint.x,
            controlPoint.y,
    ...
    function overrideCurveVertexFunction() {
      ...
      window.curveVertex = function (x, y) {
        if (_recording) {
          ...
          if (_drawMode === "p5") {
            _originalCurveVertexFunc.call(
              _p5Instance,
              mmToPixel$1(transformedPoint.x),
              mmToPixel$1(transformedPoint.y),
            );
          }
    ...
    function createZigzagWithJoins(pathPoints, stitchSettings) {
      ...
      const useInterpolation =
        stitchSettings.stitchInterpolate !== undefined ? stitchSettings.stitchInterpolate : false;
