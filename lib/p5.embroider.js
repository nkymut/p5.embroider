(function (factory) {
  ...
  function p5EmbroiderAddon(p5, fn, lifecycles) {
      ...
      fn.vertex = function (x, y, z_or_moveTo, u, v) {
        if (_recording) {
          ...
          if (_drawMode === "p5") {
            ...
            _originalVertexFunc.call(_p5Instance, mmToPixel$1(x), mmToPixel$1(y));
          }
    ...
    function _passthroughBezierSegment(points, target = _p5Instance, convertMm = true) {
      ...
      const u = (v) => (convertMm ? mmToPixel$1(v) : v);
      if (_isP5v2) {
    ...
    function drawTextInPixels(str, x, y, maxWidth, maxHeight, fontSize) {
      ...
      if (typeof maxWidth === "undefined") {
        _originalTextFunc.call(_p5Instance, str, mmToPixel$1(x), mmToPixel$1(y));
      } else if (typeof maxHeight === "undefined") {
        _originalTextFunc.call(_p5Instance, str, mmToPixel$1(x), mmToPixel$1(y), mmToPixel$1(maxWidth));
      } else {
