(function (factory) {
  ...
  (function (global) {
    ...
    function sashikoStitching(x1, y1, x2, y2, stitchWidth, stitchLength) {
      ...
      const stitches = [];
      _stitchData.threads[_currentThreadIndex]?.weight || 0.2;
      ...
      while (currentDist < distance) {
        ...
        if (isMultiline) {
          ...
          const lineStitches = multiLineStitching(segStartX, segStartY, segEndX, segEndY, stitchWidth);
          stitches.push(...lineStitches);
